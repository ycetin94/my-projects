...
DATABASES = {
    'default': {
        ...
        'HOST': 'ws-capstone-rds.cgudloo00tcy.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'yusufblog' # please enter your s3 bucket name
